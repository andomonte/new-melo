...
const ImportarXmlNFeEntradaPage = () => {
  ...
  useEffect(() => {
    ...
    const telaAtual = '/compras/entrada-xml/importar-nfe';
    ...
    if (!permissaoEncontrada) {
      router.replace('/compras/requisicoes-compra');
      return;
    }
...
export default ImportarXmlNFeEntradaPage;