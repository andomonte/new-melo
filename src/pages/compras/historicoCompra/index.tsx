...
const HistoricoCompraPage = () => {
  ...
  useEffect(() => {
    ...
    // A tela no banco está como /comprador/historicoCompra
    const telaAtual = '/comprador/historicoCompra';
...
export default HistoricoCompraPage;
