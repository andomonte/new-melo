/**
 * Endpoint de login para o modulo de Alocacao de Entradas
 * POST /api/entrada/alocacao/login
 */
...
export default async function handler(
  ...
  try {
    ...
    if (result.rows.length === 0) {
      console.warn('Falha autenticacao alocacao:', {
        matricula: matricula.substring(0, 3) + '***',
        filial,
      });
    ...
    console.log('Login alocacao sucesso:', {
    ...
    console.error('Erro critico login alocacao:', error);
