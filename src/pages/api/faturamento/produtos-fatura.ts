...
export default async function handler(
  ...
  try {
    ...
    if (result.rows.length === 0) {
      return res
        .status(404)
        .json({ error: 'Nenhum produto encontrado para esta fatura' });
    }
