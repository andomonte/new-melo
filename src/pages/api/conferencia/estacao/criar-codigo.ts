...
/**
 * Estação de Conferência — criação do código de acesso no PRIMEIRO ACESSO.
 * Mesmo cadastro (dbfunc_estoque) usado pela separação. Só troca quando o
 * código atual ainda é igual à matrícula; novo código único e diferente da matrícula.
 */
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    console.error('Erro em conferencia/estacao/criar-codigo:', error);
