...
export default async function handle(
  ...
  try {
    ...
    if (
      ...
      // Garantir que campo contato aceita JSON
      try {
      ...
      const contatoJson = JSON.stringify({
        ...
        entrega: {
          ...
          uf: data.ufEntrega || '',
          pais: data.paisEntrega || '',
          iest: data.iestEntrega || '',
          imun: data.imunEntrega || '',
          suframa: data.suframaEntrega || '',
        },
      });
      await client.query(
