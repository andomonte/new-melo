...
/**
 * Lista as filiais disponíveis para a Estação de Separação.
 * Fonte: tb_login_filiais (no banco central MANAUS). O nome_filial já casa
 * com as chaves de env (MANAUS/RONDONIA/RORAIMA) usadas por getPgPool.
 */
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    console.error('Erro em estacao/filiais:', error);
