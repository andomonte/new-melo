...
const LoginRecebimento: React.FC<LoginRecebimentoProps> = ({
  onLoginSuccess,
}) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Usar o mesmo endpoint de login do conferencia (mesma tabela dbfunc_estoque)
      const response = await fetch('/api/conferencia/login', {
        method: 'POST',
        headers: {
      ...
      toast({
        ...
        description: `Bem-vindo(a) ao painel de recebimento, ${operador.nome}!`,
        variant: 'default',
      });
