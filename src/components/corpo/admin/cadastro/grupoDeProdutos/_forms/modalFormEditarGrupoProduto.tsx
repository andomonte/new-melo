// src/components/gruposDeProdutos/_forms/modalFormEditarGrupoProduto.tsx
import React from 'react';
import { UseFormRegister, FieldErrors } from 'react-hook-form';
import { UpdateGrupoProdutoFormInput } from '@/data/gruposDeProdutos/gruposProdutoSchema';
import { X } from 'lucide-react';
import FormInput from '@/components/common/FormInput';
import FormFooter from '@/components/common/FormFooter2';
import Carregamento from '@/utils/carregamento';

interface ModalFormEditarGrupoProdutoProps {
  titulo: string;
  onClose: () => void;
  loading?: boolean;
  handleSubmit: () => void;
  handleClear: () => void;
  register: UseFormRegister<UpdateGrupoProdutoFormInput>;
  errors: FieldErrors<UpdateGrupoProdutoFormInput>;
  isDirty: boolean;
}

const ModalFormEditarGrupoProduto: React.FC<
  ModalFormEditarGrupoProdutoProps
> = ({
  titulo,
  handleSubmit,
  handleClear,
          ...
          <div className="bg-white dark:bg-zinc-700 rounded-lg p-6 shadow space-y-6 max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {/* Código Grupo de Produto - READ ONLY */}
                <FormInput
                  ...
                  disabled
                  className="bg-gray-100 dark:bg-zinc-600 cursor-not-allowed"
                  maxLength={5}
                />
...
export default ModalFormEditarGrupoProduto;
