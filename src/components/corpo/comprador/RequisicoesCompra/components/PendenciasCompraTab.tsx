...
export default function PendenciasCompraTab() {
  ...
  const carregarPendencias = useCallback(async () => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        toast({
          title: 'Erro',
          description: response.data.error || 'Erro ao carregar pendências',
          variant: 'destructive'
        });
      }
    } catch (error) {
  ...
  }, [page, perPage, filialSelecionada, marcaSelecionada, toast]);

  useEffect(() => {
    carregarPendencias();
  }, [carregarPendencias]);

  // Filtrar por referência localmente
