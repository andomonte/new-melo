...
import { ChevronLeft, ChevronRight, Filter, FilterX, BarChart3, Check, CheckCheckIcon, Columns3, Eye, EyeOff, GripVertical, FileSpreadsheet } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuTrigger,
  DropdownMenuContent,
...
interface DataTableContasReceberProps {
  headers: string[];
  rows: any[];
  meta: Meta;
...
export default function DataTableContasReceber({
  headers,
  rows,
  meta,
  onPageChange,
  ...
  return (
    <div className="border border-gray-300 dark:border-gray-300 bg-white dark:bg-zinc-900 rounded-lg flex flex-col w-full min-h-0 overflow-hidden">
              ...
              <DropdownMenuContent className="w-48 bg-white dark:bg-zinc-900 shadow-md border border-gray-300 dark:border-zinc-600 text-sm text-gray-700 dark:text-white cursor-pointer">
                ...
                {onExportarExcel && (
                  <DropdownMenuItem
                    ...
                    className="cursor-pointer hover:bg-gray-100 dark:hover:bg-zinc-700"
                  >
                    <FileSpreadsheet className="mr-2 size-4 text-green-600 dark:text-green-400" />
                    Exportar para Excel
                  </DropdownMenuItem>
                )}
      ...
      <div className="flex-1 min-h-0 overflow-auto" ref={containerRef}>
        <div className="min-h-0 max-h-[calc(80vh-16rem)] overflow-auto pb-8">
          <div
          ...
          >
            ...
            <colgroup>
              {columnWidths && columnWidths.length > 0 ? (
                ...
                columnWidths.map((width: string, index: number) => (
